    ...
    <div className="flex items-center justify-center  w-full h-full">
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-96 lg:h-[52rem]  px-4 ">
        ...
        <div className="absolute w-full bottom-0 lg:bottom-52 flex justify-center z-40 ">
          <div className="flex lg:gap-2 ">
            <p className="text-xs mt-2 w-52 lg:mt-6 lg:w-full lg:text-sm lg:mr-56 text-center">
              Copyright 2024{" "}
              <span className="font-light text-gray-300">Ouadou Mohamed.</span>{" "}
            ...
            {socialMedia.map((profile) => (
              <a
                ...
                className="p-2 bg-transparent border-none cursor-pointer focus:outline-none mr-2"
              >
                <img
                  src={profile.img}
                  alt={profile.name}
                  width={20}
                  height={20}
               className="transition-transform transform hover:scale-110 lg:w-10 lg:h-10"
                />
              </a>
            ))}
          </div>
        ...
        <motion.div
          ...
          className="absolute lg:top-20  w-[380px]  lg:w-full flex flex-col items-center justify-center transform -translate-x-1/2 z-50"
        >
          <h1 className="heading text-center text-[16px] lg:text-[32px] lg:mb-10 font-bold uppercase">
            Let’s Connect:{" "}
