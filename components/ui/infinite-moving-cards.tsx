              ...
              ></div>
               <div className="relative z-20 mb-6 flex flex-row items-center">
                <img
                  src={item.avatar}
                  alt={item.name}
                  className="w-10 h-10 lg:w-20 lg:h-20 rounded-full object-cover mr-1 lg:mr-4"
                />
                <div className="flex flex-col justify-center">
                  <span className="text-sm lg:text-lg leading-[1.6] text-gray-400 font-normal">
                    {item.name}
                  </span>
                  <span className="text-xs lg:text-base leading-[1.6] text-gray-400 font-light lg:font-normal">
                    {item.title}
                  </span>
                </div>
              </div>
              <span className="relative z-20 text-sm lg:text-lg  leading-[1.6] text-gray-100 font-normal">
