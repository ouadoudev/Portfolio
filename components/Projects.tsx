    ...
    <div id="projects">
      <div className="lg:py-8">
        ...
        <div className="lg:px-8">
          {/* Flex for small screens, Grid for large screens */}
          <div className="flex overflow-x-auto space-x-2 my-8 lg:grid lg:grid-cols-3 lg:gap-4">
            {projects.map((item) => (
              <div
                className="h-[28rem] flex items-center justify-center flex-shrink-0 lg:h-[35rem]"
                key={item.id}
              >
